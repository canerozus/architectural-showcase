...
### Frontend
- **Dispatch-Ops-UI** → `frontend/Dispatch-Ops-UI-mini-case/`  
  Problem: build a feature-based UI with predictable data flows and reusable components.  
  Signals: TanStack Router/Query integration, optimistic updates, composable UI primitives.
